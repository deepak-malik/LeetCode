...
public class SingleNumber1Test {
	...
	public void singleNumber1Test1() {
		int[] array = {1};
		Assert.assertEquals(SingleNumber1.findLonelyInteger(array), 1);
	}
	...
	public void singleNumber1Test2() {
		...
		Assert.assertEquals(SingleNumber1.findLonelyInteger(array), 8);
	}
	...
	public void singleNumber1Test3() {
		int[] array = {};
		Assert.assertEquals(SingleNumber1.findLonelyInteger(array), 0);
	}
